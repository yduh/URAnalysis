...
'''
Two trees are provided in the format file.root:path/to/tree

The script compares entry-by-entry that all the branches 
are exactly equal. (custom precision to be implemented)

If there is a mismatching in the tree naming the option
--map="{'branch1':'branch2'}" 
