#ifndef PATLeptonTrackVectorExtractor_h
#define PATLeptonTrackVectorExtractor_h
 ...
 * importerd from https://github.com/uwcms/FinalStateAnalysis/blob/master/PatTools/interface/PATLeptonTrackVectorExtractor.h
 * by Mauro Verzetti
 */
